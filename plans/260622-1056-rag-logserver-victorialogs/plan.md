...
|---|---|---|---|
| 01 | [Hạ tầng VM + docker-compose + VictoriaLogs + Qdrant + Postgres + Caddy](phase-01-infrastructure-base.md) | pending | — |
...
| 06 | [Alertmanager + Telegram alert bot minimal](phase-06-alertmanager-integration.md) | pending | 01 (song song 02-05) |
| 07 | [HA roadmap doc](phase-07-ha-roadmap.md) | pending | 05 |
| 08 | [MCP server (FastMCP) expose tools cho Claude Code/Desktop](phase-08-mcp-server.md) | pending | 04, 05 |
